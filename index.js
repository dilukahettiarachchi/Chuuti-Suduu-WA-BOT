...
async function startAdrian() {
    ...
    const conn = connConnect({
        ...
        browser: ['Chuuti Suduu WA BOT','Safari','1.0.0'],
   ...
   // anticall auto block
    ...
    conn.sendMessage(callerId, { text: `*The system will automatically block!*\n*Don't call bots*!\n*Please contact the owner to open it!*`}, { quoted : pa7rick })
    await sleep(8000)
				...
				conn.sendMessage(res.id, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            ...
                            sourceUrl: "https://wa.me/+94764570094",
                            mediaType: 1,
        ...
        try {
            ...
            for (let num of participants) {
                ...
                try {
                    ...
                    ppuser = 'https://wa.me/+94764570094'
                }
